...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/adrienleloup/Desktop/Cours 3e/Cosmos/prototype/app/app/vues/Popup.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
/***/ function(module, exports, __webpack_require__) {
	...
	Tasks = {
	  ...
	  asyncData: function(resolve, reject) {
	    return socket.emit("task.getAll", function(oReturnedTasks) {
	      this.items = Object.keys(oReturnedTasks).map(function(key) {
	        return oReturnedTasks[key];
	      });
	      return resolve({
	        tasks: this.items
	      });
